...
function bindElements() {
  [
    ...
    'authBtn','authPanel','closeAuthBtn','authEmail','loginBtn','logoutBtn','syncLocalBtn','authStatus','magicLinkHelp'
...
function setEditMode() {
  ...
  if (els.authBtn) els.authBtn.textContent = isAdmin ? 'Compte SudExpé' : 'Connexion SudExpé';
...
async function loginSupabase() {
  ...
  if (!email) return toast('Renseignez votre adresse e-mail SudExpé.');
